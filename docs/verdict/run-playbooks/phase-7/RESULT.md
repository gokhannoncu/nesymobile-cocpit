...
| Recovery instruction | `Phase 7 başlamadı. Önce Phase 6 RESULT içinde resultState COMPLETED ve phase7Readiness READY_WITH_EXTERNAL_BLOCKERS doğrulanmalı. Real DUT yoksa full CP7 PASS verme.` |
